...
<div class="container">
	<c:forEach var="experiment" items="${ sessionScope.experiments }">
        ...
        <p>
            ...
            <input type="text" name="name" value="${experiment.name }" size="51" />
        </p>
        <p>
            <span class="title"><label for="type">类型:</label></span>
            <input type="text" name="type" value="${experiment.type }" size="51" />
        </p>
        <p>
            <span class="title"><label for="duration">截至时间:</label></span>
            <input type="text" name="duration" value="${ experiment.duration}" size="51" />
        </p>
        <h1>实验详细内容</h1>
        <p>
            <span class="title"><label for="purpose">实验目的:</label></span>
            <textarea name="purpose"  cols="45" rows="6">${ experiment.purpose}</textarea>
        </p>
        <p>
            <span class="title"><label for="demand">实验要求:</label></span>
            <textarea name="demand" cols="45" rows="6">${ experiment.demand}</textarea>
        </p>
        <p>
            <span class="title"><label for="description">实验描述:</label></span>
            <textarea name="description" cols="45" rows="6">${ experiment.description}</textarea>
        </p>
